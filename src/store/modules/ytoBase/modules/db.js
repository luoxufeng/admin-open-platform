...
function pathInit ({
  ...
  const uuid = getStore('uuid') || 'ghost-uuid'
...
export default {
  ...
  actions: {
     ...
     * @param {Object} param user {Boolean} 是否区分用户
     */
    databasePage (context, { vm, basis = 'name', user = false } = {}) {
      return new Promise(resolve => {
        resolve(
          db.get(
            pathInit({
     ...
     * @param {Object} param user {Boolean} 是否区分用户
     */
    databasePageClear (context, { vm, basis = 'name', user = false } = {}) {
      return new Promise(resolve => {
        resolve(
          db.get(
            pathInit({
     ...
     * @param {Object} param user {Boolean} 是否区分用户
     */
    pageSet (context, { vm, basis = 'name', user = false }) {
      return new Promise(resolve => {
        resolve(
          db.get(
            pathInit({
     ...
     * @param {Object} param user {Boolean} 是否区分用户
     */
    pageGet (context, { vm, basis = 'name', user = false }) {
      return new Promise(resolve => {
        resolve(
          db
            .get(
     ...
     * @param {Object} param user {Boolean} 是否区分用户
     */
    pageClear (context, { vm, basis = 'name', user = false }) {
      return new Promise(resolve => {
        resolve(
          db.get(
            pathInit({
